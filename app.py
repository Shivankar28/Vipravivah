...
def explore():
    ...
    try:
        ...
        # Use LEFT JOIN to include all profiles even if some details are missing
        query = """
        SELECT p.id, p.name_first, p.name_last, p.gender, p.dob, p.religion, 
               ...
               p2.temp_city, p2.temp_state, p3.qualification, p3.working_status, 
...
@app.route('/contact')
def contact():
    return render_template('bhadwa.html')
